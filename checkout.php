...
if(isset($_POST['place_order'])){
	...
	if($is_error==''){
		...
		$delivery_date=get_safe_value($_POST['delivery_date']);
		$delivery_time=get_safe_value($_POST['delivery_time']);
		...
		$sql="insert into order_master(user_id,name,email,mobile,address,zipcode,total_price,order_status,payment_status,added_on,delivery_date,delivery_time,coupon_code,final_price,payment_type) values('".$_SESSION['FOOD_USER_ID']."','$checkout_name','$checkout_email','$checkout_mobile','$checkout_address','$checkout_zip','$totalPrice','1','pending','$added_on','$delivery_date','$delivery_time','$coupon_code','$final_price','$payment_type')";
											...
											<form method="post">
												<div class="billing-information-wrapper">
													<div class="row">
														...
														<input type="date" class="form-control" name="delivery_date" id="delivery_date" required value="<?php echo $delivery_date?>"><br>
														<label>Delivery Time</label>
														<input type="time" class="form-control" name="delivery_time" id="delivery_time" required value="<?php echo $delivery_time?>">
	                                                    </div>
	                                                    </div>
													...
													<div class="ship-wrapper">
														...
														<div class="single-ship">
															<input type="radio" name="payment_type" value="paytm" disabled>
														...
														?>
														<div class="single-ship">
															<input type="radio" name="payment_type" value="wallet" <?php echo $is_dis?> disabled>
															<label>Wallet</label>
								...
								<ul>
									...
									<li class="single-shopping-cart">
										...
										<div class="shopping-cart-title">
											<h4><a href="#">Cart Details </a></h4>
											<h6>Qty: <?php echo $list['qty']?></h6>
											<span><?php echo $list['qty']*$list['price'];?> Rs</span>
										</div>
										<div><p>Delivery Charges Rs 100</p></div>
										
									</li>
									<?php } ?>
								</ul>
								<div class="shopping-cart-total">
									<h4>Total : <span class="shop-total"><?php echo $totalPrice +100?> Rs</span></h4>
								</div>
