                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-7">
                            <div class="copyright">
                                <p>Copyright © <a href="https://www.cremeux.in">Cremeux.</a> . All Right Reserved.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-5">
                            <div class="footer-social">
                                <ul>
                                    <li><a href="https://www.facebook.com/cremeuxgoa"><i class="ion-social-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/CMMARENA"><i class="ion-social-twitter"></i></a></li>
                                    <li><a href="https://www.instagram.com/cremeuxgoa/"><i class="ion-social-instagram-outline"></i></a></li>
