                  ...
                  <div class="card-body">
                    ...
                    <div class="container-fluid d-flex justify-content-between">
                      <div class="col-lg-3 pl-0">
						...
						<p>CMM Building, 2nd Floor,</p>
						<p>Renowadi, Merces, Goa.</p>
						<p>Pincode: 403005</p>
                      </div>
                    ...
                    <div class="container-fluid d-flex justify-content-between">
                      <div class="col-lg-3 pl-0">
						...
						<p class="mb-0 mt-5">Delivery Date : <?php  echo dateFormat($orderRow['delivery_date'])?></p>
						<p class="mb-0 mt-5">Delivery Time : <?php  echo ($orderRow['delivery_time'])?></p>
                      </div>
                    </div>
					...
					$paymentstatus=mysqli_query($con,"select * from order_master order by payment_status");
					?>
					...
					<div>
						...
						<br/>
						<?php
							echo "<h4>Payment Status:- ".$orderRow['payment_status']."</h4>";
						?>
						<select class="form-control wSelect200" name="order_status" id="opayment_status" onchange="updatePaymentStatus()">
							<option val=''>Payment Status</option>
							<?php 
							while($paymentStatusRow=mysqli_fetch_assoc($orderStatusRes)){
								echo "<option value=".$paymentStatusRow['id'].">".$paymentstatus['payment_status']."</option>";
							}
							?>
						</select>
						<br/>
...
function updatePaymentStatus(){
	...
	if(payment_status!=''){
		var oid="<?php echo $id?>";
		window.location.href='<?php echo FRONT_SITE_PATH?>admin/order_detail.php?id='+oid+'&payment_status='+payment_status;
	}
}
